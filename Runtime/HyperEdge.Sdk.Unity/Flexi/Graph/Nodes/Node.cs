...
namespace HyperEdge.Sdk.Unity.Flexi
{
    ...
    public abstract class Node
    {
        ...
        //[NonSerialized]
        private readonly Dictionary<string, Port> portTable = new Dictionary<string, Port>();
        //[NonSerialized]
        private readonly Dictionary<string, Inport> inportTable = new Dictionary<string, Inport>();
        //[NonSerialized]
        private readonly Dictionary<string, Outport> outportTable = new Dictionary<string, Outport>();

        private readonly List<Inport> inports = new List<Inport>();
        private readonly List<Outport> outports = new List<Outport>();
        private readonly List<Inport> dynamicInports = new List<Inport>();
        private readonly List<Outport> dynamicOutports = new List<Outport>();
