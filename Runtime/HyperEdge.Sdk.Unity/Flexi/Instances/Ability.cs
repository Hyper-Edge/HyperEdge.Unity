...
namespace HyperEdge.Sdk.Unity.Flexi
{
    ...
    public class Ability
    {
        ...
        private readonly List<BlackboardVariable> variableList = new List<BlackboardVariable>();
        private readonly Dictionary<string, BlackboardVariable> variableTable = new Dictionary<string, BlackboardVariable>();
        private readonly List<AbilityFlow> abilityFlows = new List<AbilityFlow>();
