...
namespace HyperEdge.Sdk.Unity.Flexi
{
    ...
    {
        private static readonly StatRefreshEvent STAT_REFRESH_EVENT = new StatRefreshEvent();
        ...
        private readonly AbilityEventQueue eventQueue = new AbilityEventQueue();
        private readonly StatRefreshRunner statRefreshRunner = new StatRefreshRunner();

        private readonly MacroLibrary macroLibrary = new MacroLibrary();
        private readonly AbilityPoolManager poolManager;

        private readonly List<Ability> _cachedAbilites = new List<Ability>(8);
