...
namespace HyperEdge.Sdk.Unity.Flexi.GraphDataFixer
{
    public class ValidationResult
    {
        internal List<GraphAsset> invalidAssets = new List<GraphAsset>();
        internal List<string> invalidTypeNames = new List<string>();
    }
