...
namespace HyperEdge.Sdk.Unity.Flexi.GraphViewEditor
{
    public class NodeTypeSearchTree : IEnumerable<NodeTypeSearchTree.Node>
    {
        public class Node
        {
            ...
            private readonly List<NodeTypeSearchTree.Node> children = new List<NodeTypeSearchTree.Node>();
        ...
        {
            private readonly NodeTypeSearchTree.Node root;
            private readonly Stack<int> nodeIndexPath = new Stack<int>();
        ...
        private readonly NodeTypeSearchTree.Node root = new NodeTypeSearchTree.Node(null, "", null, 0);
