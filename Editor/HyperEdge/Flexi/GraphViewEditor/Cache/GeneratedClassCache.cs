...
namespace HyperEdge.Sdk.Unity.Flexi
{
    ...
    internal static class GeneratedClassCache
    {
        ...
        private static readonly CacheImplementation CACHE_FOR_MONO_BEHAVIOUR = new CacheImplementation();
        private static readonly CacheImplementation CACHE_FOR_SCRIPTABLE_OBJECT = new CacheImplementation();
        ...
        private class CacheImplementation
        {
            ...
            private readonly Dictionary<string, Type> classTable = new Dictionary<string, Type>();
