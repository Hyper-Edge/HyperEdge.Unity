...
namespace HyperEdge.Sdk.Unity.Flexi.GraphViewEditor
{
    public class BlackboardInspector : VisualElement
    {
        ...
        private readonly List<BlackboardVariable> variables = new List<BlackboardVariable>();

        private readonly HashSet<VisualElement> bindingItems = new HashSet<VisualElement>();
        private readonly Dictionary<VisualElement, IDisposable> callbackTable = new Dictionary<VisualElement, IDisposable>();
