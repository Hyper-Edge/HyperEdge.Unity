...
using HyperEdge.Sdk.Unity.Flexi.GraphViewEditor;
using UnityEditor;
using UnityEngine;

namespace HyperEdge.Sdk.Unity.Flexi.NodeSearcher
{
    public class NodeSearcher : EditorWindow
    {
        ...
        private readonly List<ResultItem> results = new List<ResultItem>();
        private readonly List<bool> isGraphChecked = new List<bool>();
